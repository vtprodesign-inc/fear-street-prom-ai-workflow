...
class BloodOverlayCompositor(CallbacksExt):
    """  """
    ...
    def pulse_Editextension(self):
        self.ownerComp.op('BloodOverlayCompositor').par.edit.pulse()
    
    def pulse_Detectfaces(self):
        ''' run face detection '''
        self.DetectFaces()
    
    def DetectFaces(self):
        ''' run face detection '''
        facedetectionScriptOp = self.ownerComp.op('opencv_find_faces')
        facedetectionScriptOp.run()
